...
6. Sixth, it presupposes that the Creator exists and that He has spoken to our race. It accepts the implied divine purpose to preserve His rev-elation for the use of subsequent generations, including ours. It un-derstands that both God and Satan have an ongoing active interest in the fate of the NT Text—to approach NT textual criticism without taking due account of that interest is to act irresponsibly.[^ci-ktorzy-wykluczaja-skazuja]
Po szóste, zakłada to, że Stwórca istnieje i że przemówił On do naszej rasy. Przyjmuje to dorozumiany boski zamysł, by zachować Jego objawienie dla użytku kolejnych pokoleń, w tym naszego. Rozumie to, że zarówno Bóg, jak i Szatan wykazują nieustanne, aktywne zainteresowanie losami Tekstu Nowego Testamentu – podchodzenie do krytyki tekstowej Nowego Testamentu bez należytego uwzględnienia tego zainteresowania jest działaniem nieodpowiedzialnym.[^ci-ktorzy-wykluczaja-skazuja] 

7. Seventh, it insists that presuppositions and motives must always be addressed and evaluated.6
Po siódme, kładzie nacisk na to, że należy zawsze uwzględniać i oceniać założenia i motywy.[^w-kazdym-dochodzeniu-dowody-zalozenia]

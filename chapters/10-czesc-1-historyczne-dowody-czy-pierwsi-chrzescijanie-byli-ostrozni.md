...
Około roku 208 nawoływał heretyków do udania się do kościołów apostolskich, w których trony apostołów nadal górują w swoich miejscach, w których czytane są ich autentyczne pisma (*authenticae* [z łac. prawdziwie, autentyczne, przyp. tłum.]), wyrażające głos i reprezentujące twarz każdego z nich z osobna. Achaja jest bardzo blisko was, (w której) znajduje się Korynt. Ponieważ nie jesteście daleko od Macedonii, macie Filippi, (a tam też) macie Tesaloniczan. Ponieważ możecie przeprawić się do Azji, macie Efez. Ponieważ ponadto jesteście blisko Włoch, macie Rzym, z którego dociera nawet do naszych własnych rąk sam autorytet (samych apostołów). [^against-heretics-peter-holmes-iii-36]

Niektórzy uważali, że Tertulian twierdził, że autografy Pawła były nadal czytane w jego czasach (208), ale na pewno miał na myśli przynajmniej, że korzystali z wiernych kopii. Czy coś innego można było oczekiwać? Na przykład, gdy Chrześcijanie z Efezu widzieli, że Autograf listu Pawła do nich zaczyna się niszczyć, czyż nie wykonaliby starannie identycznej kopii do swojego dalszego użytku, a która zawierałaby oświadczenie o tym, że została ona uwierzytelniona? Czy pozwoliliby Autografowi zginąć bez wykonania takiej kopii? (Musiał być ciągły napływ ludzi, którzy przychodzili, albo aby zrobić kopie ich listu, albo aby zweryfikować poprawność odczytu). Uważam, że jesteśmy zobowiązani do wniosku, że w roku 200 Kościół w Efezie nadal był w stanie poświadczyć oryginalne sformułowania swojego listu (i tak samo w przypadku innych) – ale jest to współczesne z papirusami P^46^, P^66^ i P^75^[^wspolczesne-papirusy-46-66-75]!
...
Dyscyplina krytyki tekstu (jakiegokolwiek tekstu) bazuje na założeniu/insynuacji/oświadczeniu, że istnieją uzasadnione wątpliwości co do dokładnego oryginalnego sformułowania tekstu. Nikt nie zajmuje się krytyką tekstu na przykład Biblii Króla Jakuba z 1611 roku, ponieważ nadal istnieją egzemplarze oryginalnego wydania. W odniesieniu do krytyki tekstu Nowego Testamentu **kluczową kwestią jest zachowanie jego Tekstu. Aby jakikolwiek tekst miał obiektywny autorytet, musimy wiedzieć, czym on jest.**

Jednakże, kontynuując, przypuszczalnie niektóre obszary mogą znajdować się w lepszej sytuacji, jeśli chodzi o ochronę i przekazywanie prawdziwego tekstu niż inne.
...
[^termin-odczyt]: Określenia *odczyt* oraz *lekcja* (łac. lectio) oznaczają w krytyce tekstu konkretny kształt słowa, zdania lub zapisu w badanym rękopisie (manuskrypcie) lub starym druku. Autograf to odczyt autentyczny (pierwotny), czyli słowo lub zapis, które faktycznie wyszły spod pióra autora. Odczyt błędny to zniekształcenie autografu. Przykład: manuskrypt A: „Jezus Chrystus”, manuskrypt B: „Chrystus Jezus”, manuskrypt C: „Pan Jezus Chrystus”, to są trzy różne odczyty tego samego fragmentu. [przyp. tłum.]  
https://wsjp.pl/haslo/podglad/2573/lekcja/5223614/odczytanie-edytorskie
I. Bobrowski, *O naukowej polszczyźnie humanistycznej*, Katowice 2025, s. 29.
